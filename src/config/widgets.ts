...
export const homeWidgets: WidgetDefinition[] = [
  ...
  { id: "avatar", mobilePage: 0, desktop: { column: 6, row: 1, width: 1, height: 1 }, tablet: { column: 3, row: 1, width: 1, height: 1 }, mobile: { column: 4, row: 1, width: 1, height: 1 } },
  { id: "theme", mobilePage: 0, desktop: { column: 8, row: 1, width: 1, height: 1 }, tablet: { column: 4, row: 1, width: 1, height: 1 }, mobile: { column: 3, row: 2, width: 1, height: 1 } },
  { id: "appearance", mobilePage: 0, desktop: { column: 9, row: 1, width: 1, height: 1 }, tablet: { column: 3, row: 2, width: 1, height: 1 }, mobile: { column: 4, row: 2, width: 1, height: 1 } },
